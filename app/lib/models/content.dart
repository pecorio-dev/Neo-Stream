...
class Content {
  ...
  bool get isAnime => contentType == 'anime';
  bool get isSerie => contentType == 'serie';
  bool get isFilm => contentType != 'serie' && contentType != 'anime';
  String get typeLabel => isAnime ? 'Anime' : (isSerie ? 'Série' : 'Film');
  ...
  factory Content.fromJson(Map<String, dynamic> json) {
    ...
    return Content(
      ...
      seriesBaseTitle: json['series_base_title'] != null
          ? _unescapeHtml(json['series_base_title'].toString())
          : null,
