                ...
                Expanded(
                  child: Focus(
                    onKeyEvent: (node, event) {
                      ...
                      // ArrowLeft NOT intercepted here — Flutter's directional
                      // traversal moves left within the grid, and from the
                      // leftmost column it naturally reaches the nav bar items.
                      ...
                      // Numeric 1-5: switch tab and focus sidebar
    ...
    return Focus(
      ...
      onKeyEvent: (node, event) {
        ...
        if (event.logicalKey == LogicalKeyboardKey.arrowUp) {
          _navFocusNodes[index > 0 ? index - 1 : 4].requestFocus();
          return KeyEventResult.handled;
        }

        if (event.logicalKey == LogicalKeyboardKey.arrowDown) {
          _navFocusNodes[index < 4 ? index + 1 : 0].requestFocus();
          return KeyEventResult.handled;
        }
