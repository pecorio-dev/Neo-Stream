...
class _LoginScreenState extends State<LoginScreen>
  ...
  Future<void> _submit() async {
    ...
    if (user == null || !user.premiumActive) {
      destination = const PaymentWallScreen();
        ...
        children: [
          ...
          if (isTV) ...[
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: NeoTheme.infoCyan.withValues(alpha: 0.08),
                borderRadius: BorderRadius.circular(999),
                border: Border.all(
                  color: NeoTheme.infoCyan.withValues(alpha: 0.15),
                  width: 0.5,
                ),
              ),
              child: Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  Icon(Icons.videogame_asset_outlined, size: 14, color: NeoTheme.infoCyan),
                  const SizedBox(width: 8),
                  Text(
                    'Touches directionnelles + OK pour naviguer',
                    style: NeoTheme.labelMedium(context).copyWith(color: NeoTheme.infoCyan),
                  ),
                ],
              ),
            ),
        ...
        child: AutofillGroup(
          child: Column(
            ...
            Text(
              ...
              style: NeoTheme.bodyMedium(context).copyWith(color: NeoTheme.textTertiary),
            ),
            ...
            OutlinedButton(
              ...
              child: Text(
                ...
                style: NeoTheme.labelLarge(context).copyWith(color: NeoTheme.infoCyan),
              ),
            ),
            const SizedBox(height: 20),
            Row(
              ...
              children: [
                ...
                Text(
                  ...
                  style: NeoTheme.labelSmall(context).copyWith(
                    letterSpacing: 3,
                    color: NeoTheme.textDisabled.withValues(alpha: 0.5),
                    fontSize: 9,
                  ),
                ),
                const SizedBox(width: 10),
