...
class TVWrapper extends StatefulWidget {
  ...
  // À mettre à false quand l'écran contient un champ texte qui doit garder le
  // focus à l'ouverture (sinon le nœud racine le vole et le clavier ne s'ouvre pas).
