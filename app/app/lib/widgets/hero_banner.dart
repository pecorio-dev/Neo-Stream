...
class HeroBanner extends StatefulWidget {
  ...
  HeroBanner({super.key, required this.items, required this.onTap});
...
class _HeroBannerState extends State<HeroBanner> {
  ...
  void _restartAutoScroll() {
    ...
    _autoScrollTimer = Timer.periodic(Duration(seconds: 7), (_) {
                                              ...
                                              ? CachedNetworkImage(
                                                  ...
                                                  errorWidget: (_1, _2, _3) =>
                                                      Container(
                                                        ...
                                                        child: Center(
                                                          child: Icon(Icons.movie_rounded, color: Neo.textDisabled(context), size: 48),
                                                        ),
                                                      ),
                                                )
                                              : Container(
            ...
            children: [
              ...
              OutlinedButton(
                style: OutlinedButton.styleFrom(
                  ...
                  side: BorderSide(color: Neo.bgBorder(context).withValues(alpha: 0.8), width: 1.5),
                  backgroundColor: Neo.bgBase(context).withValues(alpha: 0.4),
                ),
                onPressed: () async {
