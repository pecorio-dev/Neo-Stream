...
class _HistoryScreenState extends State<HistoryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Focus(
      ...
      appBar: AppBar(
        backgroundColor: Neo.bgBase(context),
        title: Text('Historique', style: Neo.headlineMedium(context)),
        actions: [
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 18),
            Text('Aucun historique', style: Neo.titleLarge(context)),
            SizedBox(height: 8),
            Text(
...
class _RatingPill extends StatelessWidget {
  ...
  _RatingPill({required this.value});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Text(
        ...
        style: NeoTheme.labelMedium(
          context,
        ).copyWith(color: subtle ? Neo.textSecondary(context) : color),
      ),
    );
  }
}
