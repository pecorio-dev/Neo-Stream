...
class NeoTheme {
  ...
  static const Color bgOverlay = Color(0xFF1E1E1E);
  static const Color bgGlass = Color(0xBB141414);
  static const Color bgActive = Color(0xFF222222);
  static const Color bgHover = Color(0xFF2A2A2A);
  static const Color bgBorder = Color(0xFF2E2E2E);

  // ─── Brand ────────────────────────────────────────────────────
  static const Color primaryRed = Color(0xFFFFFFFF);
  static const Color accentBlue = Color(0xFF6366F1);
  static const Color primaryRedHover = Color(0xFFE0E0E0);
  static const Color primaryRedDark = Color(0xFF9E9E9E);
  static const Color primaryRedGlow = Color(0x33FFFFFF);
  ...
  static const Color purpleAccent = Color(0xFF9090A8);
  static const Color indigoAccent = Color(0xFF808098);
  ...
  static const LinearGradient topPanelGradient = LinearGradient(
    ...
    colors: [Color(0xDD1A1A2E), Color(0xDD0F0F1A)],
  );
  ...
  /// Universally enabled to ensure D-pad remote controls always work.
