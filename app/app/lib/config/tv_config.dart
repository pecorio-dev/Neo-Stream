...
class TVTheme {
  ...
  /// Style épuré : toutes les puces de genre partagent une teinte neutre
  /// alignée sur le thème (gris clair), sans couleurs hors-palette.
  static Color getGenreColor(String genre) => textSecondary;
